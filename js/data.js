...
const CLIENT_PROJECTS = [
  ...
  },
  {
    ...
    type: 'artista',
    featured: true,
    tagline: 'La primera boy band de Guatemala',
    desc: 'Sitio web oficial para la primera boy band de Guatemala — identidad digital, música, redes y presencia en línea para artistas independientes.',
    tech: ['HTML/CSS/JS', 'GitHub Pages'],
    video: 'assets/videos/personal/emprendedores/los-skeepers.mp4',
    demo: 'https://madco-py.github.io/Los_Skeepers/',
    repo: '',
    sold: false,
    label: 'Artista',
  },
  {
    id: 'walter-music',
    name: 'Walter Mazariegos',
    type: 'artista',
    tagline: 'Músico y compositor independiente',
    desc: 'Portfolio digital para músico y compositor guatemalteco — galería, obras, contacto y presencia profesional en línea.',
    tech: ['HTML/CSS/JS', 'GitHub Pages'],
    video: 'assets/videos/personal/emprendedores/walter.mp4',
    demo: 'https://madco-py.github.io/WALTER_MUSIC/',
    repo: '',
    sold: false,
    label: 'Artista',
  },
  ...
  },
  {
    ...
    name: 'Marce Juárez',
    type: 'artista',
    tagline: 'Portfolio y contacto personal',
    desc: 'Sitio de presentación personal: portfolio, servicios y punto de contacto.',
    tech: ['HTML/CSS/JS', 'GitHub Pages'],
