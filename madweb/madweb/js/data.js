...
const PERSONAL_PROJECTS = [
  ...
  },
  {
    ...
    badge: 'emprendedor',
    desc: 'Sitio web para negocio de comida coreana — carta digital, identidad visual y presencia en línea para emprendimiento gastronómico.',
  ...
  },
  {
    ...
    name: 'March Jewelry',
    badge: 'emprendedor',
    desc: 'Catálogo en línea para negocio de joyería — presentación de productos, identidad de marca y contacto directo.',
    tech: ['HTML/CSS/JS', 'GitHub Pages'],
  ...
  },
  {
    ...
    name: 'Marce Juárez',
    badge: 'emprendedor',
    desc: 'Sitio de presentación personal para emprendedora — portfolio, servicios y punto de contacto.',
    tech: ['HTML/CSS/JS', 'GitHub Pages'],
